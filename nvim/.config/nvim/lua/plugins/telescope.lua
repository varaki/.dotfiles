return {
    ...
    config = function()
        ...
        vim.keymap.set('n', 'ff', function() telescope_builtin.find_files({ hidden = true }) end, options)
        vim.keymap.set('n', 'fg', function() telescope_builtin.live_grep({ additional_args = function() return { "--hidden" } end, }) end, options)
